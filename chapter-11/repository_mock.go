...
func (m *MockRepositoryInterface) CreateShoppingList(list *ShoppingList) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateShoppingList", list)
	ret0, _ := ret[0].(error)
	return ret0
}

// CreateShoppingList indicates an expected call of CreateShoppingList.
func (mr *MockRepositoryInterfaceMockRecorder) CreateShoppingList(list any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateShoppingList", reflect.TypeOf((*MockRepositoryInterface)(nil).CreateShoppingList), list)
}
